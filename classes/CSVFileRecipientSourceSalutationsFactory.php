...
class CSVFileRecipientSourceSalutationsFactory implements RecipientSourceFactoryInterface
{
	public function createRecipientSource(RecipientSource $recipientSourceData)
	{
		...
		$recipientSource = new CSVFileRecipientSourceSalutations(TL_ROOT . DIRECTORY_SEPARATOR . $file, $columns, $delimiter, $enclosure);
